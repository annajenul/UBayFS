...
The optimization is implemented via a genetic algorithm [@ida:fSparseGlasso] along with a Greedy algorithm for initialization, suggested in @jenul2022ubayfs, to find a proper start vector for the optimization.
